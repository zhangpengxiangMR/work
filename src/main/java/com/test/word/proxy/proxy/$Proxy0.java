...
import com.test.word.proxy.cilent.IPerson;
...
public class $Proxy0 implements IPerson {
    ...
    public void findlove(byte byte0,short short1,int int2,long long3,float float4,double double5,char char6,boolean boolean7) {
        try{
            Method m = IPerson.class.getMethod("findlove",new Class[] {byte.class,short.class,int.class,long.class,float.class,double.class,char.class,boolean.class});
    ...
    public void buyInsure(String String0,String String1,int int2,int int3) {
        try{
            Method m = IPerson.class.getMethod("buyInsure",new Class[] {java.lang.String.class,java.lang.String.class,int.class,int.class});
